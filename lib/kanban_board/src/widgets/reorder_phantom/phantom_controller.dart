...
class BoardPhantomController extends OverlapDragTargetDelegate
  ...
  final KanbanBoardState groupsState;
...
class PhantomGroupItem extends KanbanGroupItem {
...
class PassthroughPhantomContext extends FakeDragTargetEventTrigger
  ...
  KanbanGroupItem get itemData =>
      dragTargetData.reorderFlexItem as KanbanGroupItem;
